Installation:(see English version below)
1. Gestur3Bot_V1.ev3 auf dem Roboter installieren. 
2. Mit dem Speicher-Browser der Lego-SW müssen die 4 rtf-Files in das Projekt-Verzeichnis auf dem Roboter geladen werden.
3. Programm "main" starten.  

Hinweis: Um eine hohen Erkennungsquote zu erzielen, sollte der Roboter vor eine Tageslichtquelle (Fenster) gestellt werden, 
...
2. Use the Memory-Browser of the Lego-SW to put the four rtf-files in the project directory.
