...
print('Training eines Neuronalen Netzes mit KERAS(V1.1)\n')
...
n_input = 32   #32 Neuronen für die gemessenen Daten
...
model.fit(xTrain, yTrain, batch_size=1, epochs=200, verbose=2, validation_data=(xTest, yTest))
